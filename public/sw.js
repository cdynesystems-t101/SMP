...
async function processBackgroundSync(tag) {
  ...
  for (const item of pendingItems) {
    try {
      // In a real backend scenario, fetch('/api/sync', { method: 'POST', body: JSON.stringify(item) })
...
// PERIODIC BACKGROUND SYNC (if browser supports Periodic Sync API)
...
// Message Event Listener for manual or programmatic sync request from UI
